...
def update_spreadsheet():
    try:
        ...
        # Baixar e processar os dados dos fundos do mês atual
        hoje = datetime.today()
        ...
        # Verificar se todos os fundos específicos têm dados no arquivo atual
        fundos_especificos = [
            "26.673.556/0001-32",
            "10.347.493/0001-94",
            "23.272.391/0001-07", 
        ...
        for cnpj in fundos_especificos:
            ...
            # Se o fundo não estiver no arquivo atual, buscar dados do mês anterior
            if fundo.empty:
